  ...
  return (
    <>
      ...
      {data.projects.length === 0 ?
        ...
        (<div className="h-auto w-full p-1 grid grid-cols-1 sm:grid-cols-2 font-poppins lg:grid-cols-3 max-h-65 overflow-y-auto scrollbar-custom">
          {data.projects.slice(0,10).map(project=>(
            <div className="px-3 py-1 h-fit max-h-35 overflow-y-auto scrollbar-custom bg-[#18181f] m-3 rounded-xl border-2 border-white/10 flex flex-col -between" key={project._id}>
              ...
              <div className="flex gap-2 my-2 px-0.5 flex-wrap">
